...
function dataHTML(){ ?>
  ...
  <div class="table-wrapper">
    <div class="table-title">
      <div class="row">
        <div class="col-sm-6">
          <h2>Manage <b>Original PDF</b></h2>
        </div>
        <div class="col-sm-6">
          <a href="#addOriginalModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Original PDF</span></a>
